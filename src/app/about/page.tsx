...
const About = () => {
  ...
  return (
    <>
      ...
      />
      <div className="max-w-2xl mx-auto text-base-600 space-y-4 px-6 py-12">
        <h1 className="text-4xl font-bold">About Moody Droid Chat</h1>
        <p>
        ...
        <p>
          ...
          <a
            ...
            className="text-base-500 hover:text-base-600 transition-colors font-bold"
          >
            GitHub repository
          </a>
          !
